...
const SAMPLE_LINKS: ProfileLink[] = [
  { id: -1, title: "샘플 상품 1", url: "#", imageUrl: null, description: null, order: 0, enabled: true, price: 199000, originalPrice: 289000, discountRate: 31, store: "쿠팡", category: "전자제품", clicks: 1284 },
  { id: -2, title: "샘플 상품 2", url: "#", imageUrl: null, description: null, order: 1, enabled: true, price: 129000, originalPrice: 179000, discountRate: 28, store: "무신사", category: "패션", clicks: 856 },
  { id: -3, title: "샘플 상품 3", url: "#", imageUrl: null, description: null, order: 2, enabled: true, price: 549000, originalPrice: null, discountRate: null, store: "네이버", category: "생활", clicks: 342 },
];
...
export function ProductProfile({ profileData, links }: ProductProfileProps) {
  ...
  const displayLinks = enabledLinks.length > 0 ? enabledLinks : SAMPLE_LINKS;
